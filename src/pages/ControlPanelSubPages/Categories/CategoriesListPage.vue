<template>
  <v-container>
    <h2 style="text-align: right;margin-bottom: 25px;margin-top: 10px;">لیست کتگوری ها</h2>
    <v-layout>
      <v-flex xs12>
        <div>
          <v-card>
    ...
    data: function () {
      return {
        ...
        headers: [
          ...
          {text: 'نام کتگوری', value: 'name', align: 'right', sortable: false},
          {text: 'اولویت', value: 'name', align: 'right', sortable: false},
