<template>
  <v-container>
    <h2 style="text-align: right;margin-bottom: 25px;margin-top: 10px;">لیست تگ ها</h2>
    <v-layout>
      <v-flex xs12>
        <div>
          <v-card>
...
<script>
  ...
  export default {
    ...
    data: function () {
      return {
        ...
        headers: [
          ...
          {text: 'نام تگ', value: 'name', align: 'right', sortable: false},
    ...
    methods: {
      ...
      operation (id) {
        this.$router.push({name: 'TagEdit', params: {id: id}})
      },
      removeSort () {
