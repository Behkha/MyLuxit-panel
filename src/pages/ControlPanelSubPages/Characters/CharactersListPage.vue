<template>
  <v-container>
    <h2 style="text-align: right;margin-bottom: 25px;margin-top: 10px;">لیست اشخاص</h2>
    <v-layout>
      <v-flex xs12>
        <div>
          <v-card>
            ...
            >
              <template slot="items" slot-scope="props">
                ...
                <td class="text-xs-right">{{props.item.person.name}}</td>
                <td class="text-xs-right">{{props.item.character_type_fa}}</td>
                ...
                <td class="text-xs-center">
                  <v-btn outline @click="operation(props.item.character_id)" color="green white-1 white--text">ویرایش یا حذف
                  </v-btn>
                </td>
              </template>
            </v-data-table>
...
<script>
  ...
  export default {
    data: function () {
      return {
        ...
        headers: [
          ...
          {text: 'نام شخص', value: 'name', align: 'right', sortable: false},
          {text: 'نوع شخص', value: 'name', align: 'right', sortable: false},
    ...
    methods: {
      ...
      operation (id) {
        this.$router.push({name: 'CharacterEdit', params: {id: id}})
      },
      removeSort () {
